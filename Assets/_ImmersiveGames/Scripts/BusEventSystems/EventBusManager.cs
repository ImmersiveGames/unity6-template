...
namespace _ImmersiveGames.Scripts.BusEventSystems {
    ...
    public static class EventBusManager {
        ...
        /// <summary>
        /// Initializes the Unity Editor related components of the EventBusManager.
        ...
        /// <summary>
        /// Initializes the EventBusManager class at runtime before the loading of any scene.
