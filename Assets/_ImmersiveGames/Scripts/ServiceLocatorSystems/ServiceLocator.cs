...
namespace _ImmersiveGames.Scripts.ServiceLocatorSystems {
    public class ServiceLocator : MonoBehaviour {
        ...
        internal void ConfigureAsGlobal(bool dontDestroyOnLoad) {
            if (_global == this) {
                DebugManager.LogWarning<ServiceLocator>("ServiceLocator.ConfigureAsGlobal: Already configured as global", this);
            } else if (_global != null) {
                DebugManager.LogError<ServiceLocator>("ServiceLocator.ConfigureAsGlobal: Another ServiceLocator is already configured as global", this);
            } else {
                _global = this;
        ...
        internal void ConfigureForScene() {
            ...
            if (_sceneContainers.ContainsKey(scene)) {
                DebugManager.LogError<ServiceLocator>("ServiceLocator.ConfigureForScene: Another ServiceLocator is already configured for this scene", this);
                return;
            }
        ...
        public static ServiceLocator ForSceneOf(MonoBehaviour mb) {
            ...
            foreach (var go in _tmpSceneGameObjects.Where(go => go.GetComponent<ServiceLocatorScene>() != null)) {
                if (!go.TryGetComponent(out ServiceLocatorScene bootstrapper) || bootstrapper.Container == mb) continue;
